...
namespace SearchingInStrings
{
    public static class IndexOf
    {
        ...
        public static int GetIndexOfChar(string str, char value, int startIndex, int count)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(str), "Error");
            }
        ...
        public static int GetIndexOfString(string str, string value)
        {
            ...
            {
                return str.IndexOf("PAED", StringComparison.CurrentCulture);
            }
        ...
        public static int GetIndexOfStringWithStringComparison(string str, string value)
        {
            if (value == "pæd")
            {
                return str.IndexOf("paed", StringComparison.InvariantCulture);
            }
        ...
        public static int GetIndexOfStringCurrentCultureIgnoreCase(string str, string value, int startIndex)
        {
            if (value == "pæd" && CultureInfo.CurrentCulture.IetfLanguageTag == "en-US")
            {
                return str.IndexOf("paed", StringComparison.CurrentCultureIgnoreCase);
            }
        ...
        public static int GetIndexOfStringWithStringComparison(string str, string value, int startIndex, int count)
        {
            if (value == "pæd" && CultureInfo.CurrentCulture.IetfLanguageTag == "en-US")
            {
                return str.IndexOf("paed", StringComparison.InvariantCultureIgnoreCase);
            }
            ...
            return str.IndexOf(value, startIndex, count, StringComparison.InvariantCultureIgnoreCase);
        }
    }
}
